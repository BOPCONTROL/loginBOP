...
const GanadoPorcino = () => {
    ...
    function create () {
      //submit data
      addDoc(collection(db, "GanadoPorcino"), {
    ...
    return (
      <View style={styles.container}>
        <Image source={require('../assets/puerco10.jpg')} style={[
        ...
        <ScrollView>
        <Text style={styles.texto1}>Registro de Ganado Porcino</Text>
        <View>
          ...
          <TextInput style={styles.input} placeholder='Ingresa los datos' keyboardType="numeric"/>
        </View>
        <View>
          ...
          <TextInput style={styles.input} placeholder='Ingresa los datos'/>
        </View>
        <View>
